...
**X-CUBE-FREERTOS** (FreeRTOS RTOS Software Expansion for STM32Cube) provides a full integration of **FreeRTOS** in the STM32Cube environment for the STM32U5, STM32H5, STM32WBA , STM32C0, STM32U0, STM32U3 and STM32N6 series of microcontrollers.
Ready-to-run applicative examples are also provided for the *NUCLEO-H563ZI*, *NUCLEO-U575ZI-Q*, *NUCLEO-WBA55CG*, *NUCLEO-WBA65RI*, *NUCLEO-WBA25CE1*, *NUCLEO-C031C6*, *NUCLEO-U083RC*, *NUCLEO-U385RG-Q* and *NUCLEO-N657X0-Q*, thus **reducing the learning curve** and ensuring a **smooth application development experience** with FreeRTOS RTOS and STM32U5, STM32H5, STM32WBA, STM32C0, STM32U0, STM32U3 or STM32N6 MCUs.
...
- IAR Embedded Workbench for ARM (EWARM) toolchain 9.20.1 + ST-LINKV3 for STM32U5, STM32H5, STM32C0 and STM32U0
...
- IAR Embedded Workbench for ARM (EWARM) toolchain 9.60.3 + ST-LINKV3 for  STM32WBA
...
- [NUCLEO-WBA65RI](https://www.st.com/en/evaluation-tools/nucleo-wba65ri.html) *(MB2130)*
- [NUCLEO-WBA25CE1](https://www.st.com/en/evaluation-tools/nucleo-wba25ce1.html) *(MB2293)*
...
| FreeRTOS_Mutex                                      | This application demonstrates the use of mutexes to serialize access to a shared resource. [readme](./Projects/NUCLEO-WBA65RI/Applications/FreeRTOS_Mutex/README.md) |
| FreeRTOS_MPU                                        | This application demonstrates the use of the MPU with FreeRTOS to control memory/peripheral access for tasks. [readme](./Projects/NUCLEO-WBA65RI/Applications/FreeRTOS_MPU/README.md) |
| FreeRTOS_Queues_ThreadFlags_TrustZone               | This application demonstrates the use of message queues, thread flags with CMSIS_RTOS2 API along with the use of FreeRTOS when the TrustZone feature is enabled (TZEN=1) [readme](./Projects/NUCLEO-WBA65RI/Applications/FreeRTOS_Queues_ThreadFlags_TrustZone/README.md) |
| FreeRTOS_Semaphore_LowPower                         | This application demonstrates the use of FreeRTOS tickless low power mode and semaphores[readme](./Projects/NUCLEO-WBA65RI/Applications/FreeRTOS_Semaphore_LowPower/README.md) |
| FreeRTOS_Mutex                                      | This application demonstrates the use of mutexes to serialize access to a shared resource. [readme](./Projects/NUCLEO-WBA25CE1/Applications/FreeRTOS_Mutex/README.md) |
| FreeRTOS_MPU                                        | This application demonstrates the use of the MPU with FreeRTOS to control memory/peripheral access for tasks. [readme](./Projects/NUCLEO-WBA25CE1/Applications/FreeRTOS_MPU/README.md) |
| FreeRTOS_Queues_ThreadFlags_TrustZone               | This application demonstrates the use of message queues, thread flags with CMSIS_RTOS2 API along with the use of FreeRTOS when the TrustZone feature is enabled (TZEN=1) [readme](./Projects/NUCLEO-WBA25CE1/Applications/FreeRTOS_Queues_ThreadFlags_TrustZone/README.md) |
| FreeRTOS_Semaphore_LowPower                         | This application demonstrates the use of FreeRTOS tickless low power mode and semaphores[readme](./Projects/NUCLEO-WBA25CE1/Applications/FreeRTOS_Semaphore_LowPower/README.md) |
...
Other dependencies such as the HAL drivers, or the middleware libraries themselves are linked using the `git submodule` command.
Please check the instructions below for a proper use.


* To **clone** the repository, run the command below
```
git clone --recursive https://github.com/STMicroelectronics/x-cube-freertos.git
```

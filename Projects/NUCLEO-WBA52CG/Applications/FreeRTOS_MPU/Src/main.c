...
const uint32_t * __SRAM_segment_end__ = ( uint32_t * ) 0x2001FFFF;
...
const uint32_t * __privileged_sram_start__ = ( uint32_t * ) 0x20000000;
const uint32_t * __privileged_sram_end__ = ( uint32_t * ) 0x20009FFF;
...
int main(void)
{
  ...
  /* Init scheduler */
  osKernelInitialize();  /* Call init function for freertos objects (in app_freertos.c) */
  MX_FREERTOS_Init();
